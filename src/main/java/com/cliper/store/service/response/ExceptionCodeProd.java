...
public enum ExceptionCodeProd {
    ...
    GALLERY_CREATE_ERROR_INVALID_EXTENSION(HttpStatus.INVALID_ACCESS, "B001", INVALID_EXTENSION_MESSAGE),
    GALLERY_CREATE_ERROR_INVALID_IMAGE(HttpStatus.INVALID_ACCESS, "B002", INVALID_IMAGE_MESSAGE),
    GALLERY_CREATE_ERROR_INVALID_SAVE(HttpStatus.INVALID_ACCESS, "B003", INVALID_FILE_SAVE_MESSAGE),
    GALLERY_UPDATE_OK(HttpStatus.SUCCESS, "C000", GALLERY_UPDATE_MESSAGE),
    GALLERY_UPDATE_ERROR_INVALID_MATCH_GALLERY(HttpStatus.INVALID_ACCESS, "C001", GALLERY_INVALID_GET_MESSAGE),
    ...
    PORTFOLIO_CREATE_ERROR_INVALID_EXTENSION(HttpStatus.INVALID_ACCESS, "B001", INVALID_EXTENSION_MESSAGE),
    PORTFOLIO_CREATE_ERROR_INVALID_IMAGE(HttpStatus.INVALID_ACCESS, "B002", INVALID_IMAGE_MESSAGE),
    PORTFOLIO_CREATE_ERROR_INVALID_SAVE(HttpStatus.INVALID_ACCESS, "B003", INVALID_FILE_SAVE_MESSAGE),
    PORTFOLIO_UPDATE_OK(HttpStatus.SUCCESS, "C000", GALLERY_UPDATE_MESSAGE),
    PORTFOLIO_UPDATE_ERROR_INVALID_MATCH_GALLERY(HttpStatus.INVALID_ACCESS, "C001", PORTFOLIO_INVALID_GET_MESSAGE),
